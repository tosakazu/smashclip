...
|------|------|---------------------------------|
| A (regression) | MSE | Validation SRCC |
...
## Unimodal Hyperparameters (Task A Regression)
...
## Fusion Hyperparameters (Task A Regression, Early Fusion F2)
...
- **M1 (Metadata):** Learned 32-dim embeddings for killer, victim, move, and stage, concatenated (128-dim total). For Task A, 25-dim scene tag vector is also concatenated.
